...
<div class="top-nav clearfix">
   <ul class="nav pull-right top-menu">
		...
		<section id="main-content"
			style="background: url(edit/images/bg3.jpg)"no-repeat;>
								...
								<form action="EmployeeTicketServlet" method="post">
									...
									<%
										...
										PreparedStatement pstmt = conn.prepareStatement(
												"select * from tickettable where id=(select MAX(id) from tickettable where username=?) and username=?");
									...
									%>
									<div class="w3l-user">
										<label class="head">Ticket-Id<span class="w3l-star">
												* </span></label> <input type="text" name="ticketid" placeholder=""
											required="" value=<%=s2%>>
									</div>
									...
									<div class="w3l-rem">
										<div class="w3l-right">
											<label class="head">Ticket-description<span
												class="w3l-star"> * </span></label>
				...
				<label class="head">Domain<span class="w3l-star"> * </span></label>	
					<select class="category1" required="">
                        ...
                        <option>testing</option>						
									...
									<div class="w3l-user">
										<label class="head">Project Name<span class="w3l-star">
												* </span></label> <input type="text" name="projectname" placeholder=""
											"required="">
									</div>
									<div class="w3l-user">
										<label class="head">Module Name<span class="w3l-star">
												* </span></label> <input type="text" name="modulename" placeholder=""
											required="">
									</div>
									<div class="w3l-user">
										<label class="head">Requirement Name</label> <input
											type="text" name="requirementname" placeholder="">
									</div>

									<div class="w3l-options1">
										<label class="head">Assigned To<span class="w3l-star">
												* </span></label> <select class="category1" required="" name="assignedto">
...
%> --%>
									...
									<div class="w3l-options1">
										<label class="head">Assigned By<span class="w3l-star">
												* </span></label> <select class="category1" required="" name="assignedby">
									...
									<div class="w3l-date">
										<label class="head">Date of Issue<span
											class="w3l-star"> * </span></label>
										<div class="styled-input">
											<input class="date datepicker" name="dateofissue" type="text"
												placeholder="MM/DD/YYYY" onfocus="this.value = '';"
