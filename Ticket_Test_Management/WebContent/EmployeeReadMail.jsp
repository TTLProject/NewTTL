   ...
   <div class="col-md-9">
            ...
            <div class="box-body no-padding">
             ...
             <br><hr color="red">
              ...
              <div class="mailbox-read-message">
                ...
                <p style=color:navy><%=rs.getString("executive") %> Approved ticket issued to <%=rs.getString("assignedto") %></p>
          <br>
          <h5>Ticket details are shown in table below.</h5><br>
           <div id="table"  class="table-editable">
             <table  class="table" border="3">
		...
		<td><%=rs.getString("dateofissue")%></td>
              ...
              <!-- /.mailbox-read-message -->
        	   ...
        	   <%}else if(subject.equals("ApprovedReport")){
            ...
            <div class="box-body no-padding">
             ...
             <br><hr color="red">
              ...
              <div class="mailbox-read-message">
                ...
                <p style=color:navy><%=rs.getString("assignedby") %> approved your test cases regarding....</p>
          <br>
		...
		<td><%=rs.getString("dateofissue")%></td>
             ...
             <a href="ViewTestReport.jsp" ><u>click here</u></a> to view test cases
      <br><br>
      ...
      <br><br>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>Check your Modifications</h3><br>
                <h5>From: <%=rs.getString("assignedby")%>
             ...
             <br><hr color="red">
              ...
              <div class="mailbox-read-message">
                ...
                <p style=color:navy><%=rs.getString("assignedby") %> sent test cases for modification regarding....</p>
          <br>
      ...
      <a href="ModifyTestReport.jsp" ><u>click here</u></a> to modify test cases
      <br><br>
                <p >Regards,   <%=rs.getString("assignedby") %></p>
              </div>
              <!-- /.mailbox-read-message -->
